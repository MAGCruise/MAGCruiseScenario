(define-alias FishGamePlayer org.magcruise.gaming.tutorial.fish.actor.FishGamePlayer)
...
(define (def:setup-game-builder builder ::GameBuilder)
  ...
  (builder:addDefPlayers
    (def:player 'Player1 'human org.magcruise.gaming.tutorial.fish.actor.FishGamePlayer)
    (def:player 'Player2 'human org.magcruise.gaming.tutorial.fish.actor.FishGamePlayer))
