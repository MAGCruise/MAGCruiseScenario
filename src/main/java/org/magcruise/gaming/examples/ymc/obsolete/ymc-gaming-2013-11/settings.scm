(define *thanks-message* (<div-class> "notification_of_exp" (<strong> "あなたの修正により，ベトナムの児童に正しく情報が伝わりました．ありがとうございました．")))
(define *failure-message* (<div-class> "notification_of_exp" (<strong> "あなたが日本語文を修正してくれましたが，翻訳は改善されませんでした．")))
(define *instruction-message* (<div-class> "notification_of_exp" (<strong> "Bridgerであるあなたの日本文の書き換えサービスによって、翻訳文の品質が改善されます。一定の知識が伝わった場合、知識伝達がうまくいったことのお知らせや、作業に対する感謝のメッセージが、届くことがあります。")))
(define *caution-message-to-faci* (<div-class> "notification_of_exp" (<p> (<strong> "被験者IDと実験設定IDを確認して下さい．"))))


(define *q-orig-texts* ::list
  (list
  "乾田直播とは何ですか？" ;;00
  "菌はお米に害を与えますか？" ;;01
