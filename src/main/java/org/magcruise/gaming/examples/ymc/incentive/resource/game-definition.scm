(org.nkjmlab.util.langrid.LangridSchemePlugin:load)

(define-alias YMCContext org.magcruise.gaming.examples.ymc.incentive.actor.YMCContext)
(define-alias JPExpert org.magcruise.gaming.examples.ymc.incentive.actor.JPExpert)
(define-alias JPBridger org.magcruise.gaming.examples.ymc.incentive.actor.JPBridger)
(define-alias VTBridger org.magcruise.gaming.examples.ymc.incentive.actor.VTBridger)
(define-alias VTYouth org.magcruise.gaming.examples.ymc.incentive.actor.VTYouth)
