(define-private-alias CompanyPlayer org.magcruise.gaming.examples.ele.actor.CompanyPlayer)
(define-private-alias MarketContext org.magcruise.gaming.examples.ele.actor.MarketContext)
