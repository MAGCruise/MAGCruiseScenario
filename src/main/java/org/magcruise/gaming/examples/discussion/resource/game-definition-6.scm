  ...
  (builder:addDefRounds
    (def:round repeat: 2
      (def:stage type: 'parallel name: 'discussion-stage
        (def:scenario-task 'ChineseFacilitator 'talker-scenario)
        (def:scenario-task 'JapaneseDiscussant1 'talker-scenario)
        (def:scenario-task 'ChineseDiscussant1 'talker-scenario)
        (def:scenario-task 'JapaneseDiscussant2 'talker-scenario)
        (def:scenario-task 'ChineseDiscussant2 'talker-scenario)
        (def:scenario-task 'JapaneseDiscussant3 'talker-scenario)
        (def:scenario-task 'ChineseDiscussant3 'talker-scenario)
